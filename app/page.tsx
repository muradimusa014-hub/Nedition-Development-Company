    ...
    <main className="min-h-screen bg-slate-50 pt-20">
      ...
      <section className="relative min-h-[85vh] py-32 flex flex-col items-center justify-center">
        ...
        <div className="absolute inset-0 z-0 bg-slate-950">
          <img 
            src="https://plus.unsplash.com/premium_photo-1682140914933-f9704d7bc14f?q=80&w=871&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" 
